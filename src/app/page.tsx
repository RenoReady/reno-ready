...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-sand">
      ...
      <section className="relative overflow-hidden pt-16 pb-24 px-6">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
              ...
              <div className="flex flex-col gap-7">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-terracotta/10 border border-terracotta/20 w-fit">
                  ...
                  <span className="text-sm font-semibold text-terracotta tracking-tight">
                    Australia&apos;s bathroom design tool
                  </span>
                </div>

                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold text-charcoal leading-[1.05] text-balance">
                  Design Your Bathroom.{" "}
                  <span className="text-terracotta">Know The Cost.</span>{" "}
                  Then Talk To A Builder.
                </h1>

                <p className="text-xl text-charcoal/60 leading-relaxed max-w-[520px]">
                  Choose your tiles and fixtures, upload a photo, and get an
                  AI-generated preview with a real cost estimate — all before you
                  speak to a single builder.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <Link href="/builder">
                    <Button size="xl" variant="primary" className="group">
                      ...
                      <ArrowRight size={20} className="ml-1 group-hover:translate-x-1 transition-transform duration-200" />
                    </Button>
                  </Link>
                </div>

                <div className="flex flex-wrap items-center gap-5 pt-1">
                  {["3 free previews", "No credit card", "AI-powered"].map((b) => (
            ...
            {/* Right: before/after slider — scale-in on load */}
      ...
      <section className="py-4 bg-charcoal overflow-hidden">
        <Marquee duration={45}>
          <div className="flex items-center gap-8 px-10 whitespace-nowrap">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-white font-semibold text-sm">
                ...
                <span
                  ...
                  style={{ textShadow: "0 0 18px rgba(210,125,94,0.55)" }}
                >
                  1,200+
                </span>{" "}
                Australians designing their dream bathrooms
              </p>
            </div>
            ...
            <p className="text-white/45 text-xs">
              Australia&apos;s{" "}
              <span className="text-terracotta/75 font-semibold">#1</span> bathroom design tool
            </p>
            <span className="text-white/20 text-base select-none">◆</span>
          </div>
        </Marquee>
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14">
              <p className="text-sm font-bold text-terracotta uppercase tracking-widest mb-3">Why Reno Ready</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon:  PencilRuler,
                title: "Design Without an Architect",
                sub:   "Save $2,000+ in fees",
                desc:  "Get professional-quality design visualisations at a fraction of the cost. Configure tiles, tapware, and vanities in minutes — no consultancy fee required.",
              },
              {
                icon:  Repeat2,
                title: "Instant Style Exploration",
                sub:   "Try dozens of looks in seconds",
                desc:  "Swap between 16 tile combinations, 3 tapware finishes, and 2 vanity styles. See every option rendered by AI before committing to a single purchase.",
              },
              {
                icon:  FileText,
                title: "Builder-Ready Briefs",
                sub:   "Go to market with confidence",
                desc:  "Your AI preview and itemised cost estimate become your builder brief. Contractors quote faster, more accurately, and with less back-and-forth.",
              },
            ].map(({ icon: Icon, title, sub, desc }, i) => (
              <ScrollReveal key={title} delay={i * 0.12}>
                <div className="flex flex-col gap-5 p-8 rounded-3xl bg-white/60 border border-sand-200 shadow-warm-sm hover:shadow-warm transition-shadow duration-300 h-full">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-terracotta mb-3 uppercase tracking-wide">{sub}</p>
      ...
      <section id="how-it-works" className="py-24 px-6 bg-white/40 border-y border-sand-200">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                n: "01", icon: Sparkles, title: "Choose Your Style",
                desc: "Select tiles, vanity, tapware and budget. Upload a photo of your current bathroom for a personalised AI result.",
              },
              {
                n: "02", icon: DollarSign, title: "See the Preview & Cost",
                desc: "Get an AI-generated bathroom render and an itemised cost estimate based on current Australian market rates.",
              },
              {
                n: "03", icon: Users, title: "Connect with Builders",
                desc: "Share your design brief with pre-vetted local builders who can quote with confidence — no wasted meetings.",
              },
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            <p className="text-sm font-bold text-terracotta uppercase tracking-widest mb-3">16 Curated Options</p>
            ...
            <p className="text-charcoal/60 leading-relaxed max-w-md">
              From Zellige to Terrazzo, Honed Limestone to Natural Oak Look — every option is sourced from current Australian design trends.
            </p>
          </div>
          <div className="flex flex-col gap-4">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-charcoal/55">
              Get 3 free previews on sign-up. No contracts, cancel anytime.
            </p>
          </div>
            ...
            <PricingMotion index={1}>
              <PricingCard
                ...
                features={[
                  ...
                  "Structural change visualisation",
      ...
      <section id="faq" className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white/70 rounded-3xl border border-sand-200 shadow-warm-sm px-8 py-2">
            {[
              { q: "How much does a typical Australian bathroom renovation cost?",
                a: "Most Australian bathroom renovations fall between $15,000 and $30,000+, depending on the size of the space, the materials selected, and the structural changes involved. Reno Ready gives you an itemised estimate based on current market averages so you can set a realistic baseline before getting builder quotes." },
              { q: "Can I show this design to my builder?",
                a: "Absolutely. The AI preview and cost breakdown are designed to start the conversation. You can download your Reno Brief — a summary of your selections, estimated costs, and design notes — and hand it directly to any builder or architect to get an accurate quote faster." },
              { q: "How accurate is the cost estimate?",
                a: "Our estimates use current Australian market averages for materials and labour. While every home is unique, the estimate gives you a realistic baseline to prevent 'quote shock' when talking to builders. The more selections you make (tiles, tapware, structural changes), the tighter the estimate becomes." },
              { q: "Does the AI understand my specific bathroom layout?",
                a: "Yes. When you upload a photo of your current bathroom, our engine analyses the image to identify plumbing points, windows, and walls — ensuring the redesign fits your actual space, not a generic template. Without a photo, we generate a high-quality concept bathroom using your selected materials." },
              { q: "Do I own the designs created?",
                a: "Absolutely. You own everything you create on Reno Ready. Download your AI preview and Reno Brief in full resolution to share with contractors, architects, or your partner. No watermarks, no licensing restrictions." },
              { q: "What are the 3 free previews?",
                a: "Every account starts with 3 complimentary AI generation credits — no credit card required. Once used, you can upgrade to a Day Pass ($19), Monthly ($29/mo), or Annual ($69/yr) plan for unlimited access." },
            ].map(({ q, a }, i) => (
      ...
      <section className="py-24 px-6 bg-charcoal">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-terracotta/20 border border-terracotta/30 w-fit mx-auto mb-8">
            ...
            <span className="text-sm font-semibold text-terracotta">3 free previews on sign-up</span>
          </div>
      ...
      {/* ── Footer ───────────────────────────────────────────── */}
      <footer className="border-t border-sand-200 py-8 px-6 bg-sand">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-charcoal/40">
            ...
            <span>Cost estimates are indicative only. Always obtain qualified builder quotes.</span>
          </div>
        </div>
      </footer>
